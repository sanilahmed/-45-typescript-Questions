...
let value01 = 10;
let value2:number = 5;
let myName:string = "SANIL";
let myArray:string[] = ["sanil", "Ali", "Javed"];
...
console.log('Is myName is equal to sanil (lowercase)?')
console.log(myName === 'sanil' ); //False

console.log('Is myName(lowercase) is equal to sanil?')
console.log(myName.toLowerCase() === 'sanil' ); //True
...
console.log('Is sanil is in myarray')
console.log(myArray.includes('sanil')); //True
